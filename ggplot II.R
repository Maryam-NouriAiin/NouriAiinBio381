...
library(ggplot2)
library(ggthemes) # Assuming this is for theming purposes in your plots
library(patchwork)

# Your plot creations here
...
p1 <- ggplot(data=d) + 
  ...
  geom_point(data=d[d$drv=="4",]) + geom_smooth() # subset the data give dive col from d dataframe only rows with drivevariable number 4
print(p1)
